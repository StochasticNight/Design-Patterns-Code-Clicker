 ...
 */
public class AgileTeam extends Generator {
     ...
     */
    public AgileTeam(int price, double lps)
    {
        this.price = price;
        this.lps = lps;
    }
    ...
    public void incrementPrice(){
        setPrice((int) Math.ceil(100 * Math.pow(1.15, count)));
    }
    ...
    public void decrementPrice(){
        setPrice((int) Math.ceil((100 * Math.pow(1.15, count - 1))));
    }
}
